...
```bash
dtq-nodejs14.x$ sam logs -n StockCheckerFunction --stack-name dtq-nodejs14.x --tail
```
...
```bash
dtq-nodejs14.x$ cd functions/stock-checker
...
```bash
aws cloudformation delete-stack --stack-name dtq-nodejs14.x
```
