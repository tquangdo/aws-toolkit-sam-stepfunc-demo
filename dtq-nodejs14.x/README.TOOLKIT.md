...
* dtq-nodejs14.x:StockTradingStateMachine
* dtq-nodejs14.x:StockCheckerFunction (nodejs14.x)
* dtq-nodejs14.x:StockSellerFunction (nodejs14.x)
* dtq-nodejs14.x:StockBuyerFunction (nodejs14.x)
* dtq-nodejs14.x:TransactionTable
